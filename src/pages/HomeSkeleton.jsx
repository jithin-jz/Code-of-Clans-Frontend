        ...
        <div className="px-4 pt-4 pb-2">
          <div className="rounded-xl border border-white/5 bg-black p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div className="space-y-2">
              <SkeletonText width="90px" height="0.65rem" className="bg-black" />
              <SkeletonText width="160px" height="1.25rem" className="bg-black" />
            </div>
            <div className="sm:w-48 space-y-2">
              <div className="flex justify-between">
                <SkeletonText width="70px" height="0.65rem" className="bg-black" />
                <SkeletonText width="30px" height="0.65rem" className="bg-black" />
              </div>
          ...
          <section key={sectionIdx} className="px-4 py-5">
            ...
            <div className="mb-4 flex items-start justify-between gap-4">
              <div className="space-y-1.5">
                <SkeletonText width="140px" height="0.85rem" className="bg-black" />
                <SkeletonText width="220px" height="0.65rem" className="bg-black" />
              </div>
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    <div className="flex items-start gap-2 min-w-0">
                      ...
                      <div className="space-y-1.5 min-w-0 pt-0.5 flex-1">
                        <SkeletonText width="50%" height="0.6rem" className="bg-black" />
                        <SkeletonText width="85%" height="0.75rem" className="bg-black" />
                      </div>
                    </div>
                  </div>
                  <div className="flex justify-between items-center mt-3">
                    ...
                    <div className="flex gap-0.5">
                      {[1, 2, 3].map(s => <SkeletonBase key={s} className="w-2 h-2 rounded-full bg-[#1a1a1a]" />)}
                    </div>
                  </div>
                </div>
              ))}
